...
class ColaboradorLogadoEdit extends StatefulWidget {
  ColaboradorModel colaboradorModel;
  var tipoAcao;

  ColaboradorLogadoEdit({
    Key? key,
  ...
  @override
  State<ColaboradorLogadoEdit> createState() => _ColaboradorLogadoEditState();
}

class _ColaboradorLogadoEditState extends State<ColaboradorLogadoEdit> {
      ...
      child: ButtonBar(
        children: <Widget>[
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
                primary: Color.fromARGB(246, 34, 37, 44)),
            onPressed: () => {appRepository.setPage(DefaultPage())},
            child: Text("Cancelar"),
          ),
        ],
      ),
  ...
  _onClickSalvar() async {
    if (_formKey.currentState!.validate()) {
      ...
      var messageReturn = await colaboradorApi.updateColaborador(
          oColaborador, widget.colaboradorModel.idAuditor!);
